---
title: "彻底理解cookie，session，token - 墨颜丶 - 博客园"
description: "彻底理解cookie，session，token - 墨颜丶 - 博客园 的历史学习笔记。"
date: 2026-05-21
tags: ["业务系统", "认证鉴权"]
keywords: ["业务系统", "认证鉴权", "彻底理解cookie，session，token - 墨颜丶 - 博客园"]
legacy_source: "业务/彻底理解cookie，session，token - 墨颜丶 - 博客园.md"
---
...
![彻底理解cookie，session，token - 墨颜丶 - 博客园 image 1](./彻底理解cookie，session，token - 墨颜丶 - 博客园.assets/image-01.png)

后来有个叫Memcached的支了招： 把session id 集中存储到一个地方， 所有的机器都来访问这个地方的数据， 这样一来，就不用复制了， 但是增加了单点失败的可能性， 要是那个负责session 的机器挂了，  所有人都得重新登录一遍， 估计得被人骂死。

![彻底理解cookie，session，token - 墨颜丶 - 博客园 image 2](./彻底理解cookie，session，token - 墨颜丶 - 博客园.assets/image-02.png)
...
![彻底理解cookie，session，token - 墨颜丶 - 博客园 image 3](./彻底理解cookie，session，token - 墨颜丶 - 博客园.assets/image-03.png)

这个token 我不保存，  当小F把这个token 给我发过来的时候，我再用同样的HMAC-SHA256 算法和同样的密钥，对数据再计算一次签名， 和token 中的签名做个比较， 如果相同， 我就知道小F已经登录过了，并且可以直接取到小F的user id ,  如果不相同， 数据部分肯定被人篡改过， 我就告诉发送者： 对不起，没有认证。

![彻底理解cookie，session，token - 墨颜丶 - 博客园 image 4](./彻底理解cookie，session，token - 墨颜丶 - 博客园.assets/image-04.png)
...
![彻底理解cookie，session，token - 墨颜丶 - 博客园 image 5](./彻底理解cookie，session，token - 墨颜丶 - 博客园.assets/image-05.png)
